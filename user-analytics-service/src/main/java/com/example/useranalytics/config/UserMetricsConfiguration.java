package com.example.useranalytics.config;
...
public class UserMetricsConfiguration {
    ...
    public MeterRegistryCustomizer<MeterRegistry> metricsCommonTags(Environment environment) {
        return registry -> {
            ...
            registry.config()
                    .commonTags(
                        "application", "user-analytics-service",
    ...
    public MeterRegistryCustomizer<MeterRegistry> meterFilters() {
        return registry -> {
            ...
            registry.config()
                    ...
                    // Accept only specific JVM metrics and our user metrics to reduce noise
